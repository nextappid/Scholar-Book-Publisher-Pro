...
```html
<div id="wp-sbpp_book_description-wrap" class="tmce-active">
  <!-- Tabs -->
  <button id="sbpp_book_description-tmce">Visual</button>
  <button id="sbpp_book_description-html">Text</button>
  
  <!-- Visual Mode (TinyMCE) -->
  <div class="wp-editor-container">
    <iframe id="sbpp_book_description_ifr">...</iframe>
  </div>
  
  <!-- Text Mode (Textarea) -->
  <textarea id="sbpp_book_description" class="wp-editor-area"></textarea>
</div>
```
...
#wp-sbpp_book_description-wrap.tmce-active textarea.wp-editor-area {
...
```css
#wp-sbpp_book_description-wrap.html-active .wp-editor-container {
    display: none !important;  /* ← Hide TinyMCE */
}

#wp-sbpp_book_description-wrap.html-active textarea.wp-editor-area {
