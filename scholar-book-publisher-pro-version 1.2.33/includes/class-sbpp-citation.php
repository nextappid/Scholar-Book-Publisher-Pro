...
class SBPP_Citation_Generator {
    ...
    public static function get_citations($post_id) {
        ...
        $city = get_post_meta($post_id, '_sbpp_book_city', true) ?: 'Unknown City';
        ...
        if ($is_chapter) {
            ...
            $citations['apa'] = "{$apa_authors}. ({$year}). {$chapter_title}.{$editor_str} <i>{$book_title}</i>{$pages_str}. {$publisher}. {$url}";
            
            $editor_mla = $editor ? ", diedit oleh {$editor}" : "";
            $pages_mla = $pages ? ", hlm. {$pages}" : "";
            $citations['mla'] = "{$mla_authors}. \"{$chapter_title}.\" <i>{$book_title}</i>{$editor_mla}, {$publisher}, {$year}{$pages_mla}.";
            
            $editor_chi = $editor ? ", diedit oleh {$editor}" : "";
            $pages_chi = $pages ? ", {$pages}" : "";
            $citations['chicago'] = "{$chi_authors}. \"{$chapter_title}.\" Dalam <i>{$book_title}</i>{$editor_chi}{$pages_chi}. {$city}: {$publisher}, {$year}.";
        } else {
            // Book Format
            $citations['apa'] = "{$apa_authors}. ({$year}). <i>{$book_title}</i>. {$publisher}. {$url}";
            
            $citations['mla'] = "{$mla_authors}. <i>{$book_title}</i>. {$publisher}, {$year}.";
            
            $citations['chicago'] = "{$chi_authors}. <i>{$book_title}</i>. {$city}: {$publisher}, {$year}.";
        }
