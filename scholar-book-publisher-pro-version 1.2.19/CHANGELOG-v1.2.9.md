...
$(document).ready(function() {
    if (typeof tinymce !== 'undefined') {
        ...
        $(window).on('resize', function() {
            ...
            resizeTimer = setTimeout(function() {
                if (tinymce.get('sbpp_book_description') && 
                    !tinymce.get('sbpp_book_description').initialized) {
                    initializeBookDescriptionEditor();
                }
            }, 250);
        });
        ...
        $(document).on('tinymce-editor-init', function(event, editor) {
            if (editor.id === 'sbpp_book_description') {
                editor.focus();
        ...
        $(document).on('click', '.sbp-description-editor, #wp-sbpp_book_description-wrap', function() {
            if (tinymce.get('sbpp_book_description')) {
    ...
    $(document).on('click', '#sbpp_book_description-html', function() {
        setTimeout(function() {
...
#wp-sbpp_book_description-wrap {
    min-height: 350px;  /* ← Ensure container visible */
}

#wp-sbpp_book_description-wrap .mce-tinymce {
    min-height: 300px !important;  /* ← Ensure TinyMCE visible */
}

#wp-sbpp_book_description-wrap .mce-edit-area {
    min-height: 250px !important;  /* ← Ensure edit area visible */
}

#wp-sbpp_book_description-wrap iframe {
...
#sbpp_book_description {
    min-height: 250px;  /* ← Text mode minimum height */
    cursor: text;
}

#wp-sbpp_book_description-wrap .mce-tinymce.mce-container {
...
```css
#wp-sbpp_book_description-wrap { min-height: 350px; }
→ Container
