...
function focusEditor(editor) {
    ...
    setTimeout(function() {
        var $iframe = $('#sbp_book_description_ifr');
        if ($iframe.length) {
...
```javascript
// Visual tab click
$(document).on('click', '#sbp_book_description-tmce', function(e) {
    setTimeout(function() {
        var editor = tinymce.get('sbp_book_description');
        if (editor) {
...
// Text tab click
$(document).on('click', '#sbp_book_description-html', function(e) {
    setTimeout(function() {
...
function ensureVisualEditorReady() {
    ...
    if (editor) {
        ...
        tinymce.execCommand('mceAddEditor', false, 'sbp_book_description');
        setTimeout(function() {
            var newEditor = tinymce.get('sbp_book_description');
            if (newEditor) {
...
[SBP] Initializing WYSIWYG editor: sbp_book_description
