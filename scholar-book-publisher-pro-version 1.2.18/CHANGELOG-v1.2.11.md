...
$(document).on('click', '#wp-sbp_book_description-wrap', function(e) {
...
**v1.2.10 code:**
```javascript
$(document).on('click', '#wp-sbp_book_description-wrap', ...);
$(document).on('click', '.sbp-description-editor', ...);
$(document).on('click', '#sbp_book_description-tmce', ...);
$(document).on('click', '#sbp_book_description-html', ...);
```
...
function handleVisualTabClick() {
    ...
    $(document).on('click.sbpEditor', '#sbp_book_description-tmce', function(e) {
...
function handleTextTabClick() {
    $(document).on('click.sbpEditor', '#sbp_book_description-html', function(e) {
