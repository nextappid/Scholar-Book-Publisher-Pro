...
final class Scholar_Book_Publisher {
    ...
    private function init_hooks() {
        ...
        add_action('wp_ajax_sbpp_filter_books', array($this, 'ajax_filter_books'));
        add_action('wp_ajax_nopriv_sbpp_filter_books', array($this, 'ajax_filter_books'));
    ...
    public function ajax_filter_books() {
        check_ajax_referer('sbpp_filter_nonce', 'nonce');
            ...
            while ($query->have_posts()) {
                ...
                if (!empty($authors_raw) && is_array($authors_raw)) {
                    ...
                    foreach ($authors_raw as $a) {
                        if (is_array($a) && !empty($a['first_name']) && !empty($a['last_name'])) {
    ...
    public function enqueue_frontend_assets() {
        ...
        if (is_singular('scholar_book') || is_post_type_archive('scholar_book') || 
            ...
            wp_localize_script('sbp-frontend', 'sbpp_ajax', array(
                ...
                'nonce'    => wp_create_nonce('sbpp_filter_nonce'),
            ));
        }
    }
