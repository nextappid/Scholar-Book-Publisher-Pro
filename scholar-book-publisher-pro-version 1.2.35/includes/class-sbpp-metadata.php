...
class SBPP_Metadata_Generator {
    ...
    private function generate_book_metadata() {
        ...
        if (!empty($book_title)) echo '<meta name="citation_book_title" content="' . esc_attr($book_title) . '">' . "\n";
        
        if (!empty($subtitle)) echo '<meta name="citation_subtitle" content="' . esc_attr($subtitle) . '">' . "\n";
