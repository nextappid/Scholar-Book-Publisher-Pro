    ...
    <div class="scholar-main-layout">
        ...
        <aside class="scholar-sidebar">
            ...
            $years = $wpdb->get_col("
                ...
                FROM {$wpdb->postmeta} 
                WHERE meta_key = '_sbp_publication_date' 
                AND meta_value != '' 
                ORDER BY year DESC
            ");
            ...
            $languages = $wpdb->get_col("
                ...
                FROM {$wpdb->postmeta} 
                WHERE meta_key = '_sbp_book_language' 
                AND meta_value != '' 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof sbp_ajax === 'undefined') {
        console.error('Scholar Book Publisher: AJAX variables not loaded!');
    } else {
        console.log('Scholar Book Publisher: AJAX ready', sbp_ajax);
    }
...
function initializeFilters() {
    ...
    window.runAjaxFilter = function(page) {
        ...
        data.append('action',     'sbp_filter_books');
        data.append('nonce',      (typeof sbp_ajax !== 'undefined') ? sbp_ajax.nonce : '');
        ...
        const ajaxUrl = (typeof sbp_ajax !== 'undefined') ? sbp_ajax.ajax_url : '/wp-admin/admin-ajax.php';
        
        console.log('Sending AJAX to:', ajaxUrl);
        console.log('With nonce:', sbp_ajax ? sbp_ajax.nonce : 'undefined');
