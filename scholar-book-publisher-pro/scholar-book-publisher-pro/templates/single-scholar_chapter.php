...
<?php while (have_posts()) : the_post(); 
    ...
    $parent_book_id = get_post_meta(get_the_ID(), '_sbp_parent_book', true);
    ...
    $chapter_pdf = get_post_meta(get_the_ID(), '_sbp_chapter_pdf_url', true);
    $chapter_doi = get_post_meta(get_the_ID(), '_sbp_chapter_doi', true);
    ...
    if ($parent_book_id) {
        ...
        $book_publisher = get_post_meta($parent_book_id, '_sbp_book_publisher', true);
        $book_pub_date = get_post_meta($parent_book_id, '_sbp_publication_date', true);
